...
données envoyées par la carte au moniteur serie ( les données sont envoyées à une frequence inférieur au traitement pour permettre un traitement coherent" ).
